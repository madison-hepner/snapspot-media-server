...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permissionId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snapspotmediaapi.permission')),
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snapspotmediaapi.driver')),
            ],
        ),
        migrations.AddField(
            model_name='driver',
            name='permissions',
            field=models.ManyToManyField(related_name='the_driver_permissions', through='snapspotmediaapi.DriverPermissions', to='snapspotmediaapi.permission'),
        ),
        migrations.AddField(
            model_name='driver',
            name='user',
